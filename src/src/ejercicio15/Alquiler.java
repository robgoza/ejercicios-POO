...
public class Alquiler {
	...
	/**
	 * Clase alquiler. Encargada de representar un alquiler en el sistema. Los
	 * alquileres se caracterizan por su numero de amarre entre un rango de
	 * fechas determinadas. Esta clase no es la encargada de gestionar la
	 * disponibilidad de esto, tan solo se encarga de almacenarlo.
	 * 
	 * @author garciparedes
	 *
	 */
	 ...
	 * 
	 * @param amarre
	 *            Numero de amarre del alquiler.
	 * @param barco
	 *            Barco que usara el alquiler.
	 * @param nombre
	 *            Nombre del titular del alquiler.
	 * @param dni
	 *            Dni del titular del alquiler.
	 * @param fechaInicial
	 *            Fecha inicial del alquiler.
	 * @param fechaFinal
	 *            Fecha final del alquiler.
	 */
	public Alquiler(int amarre, Barco barco, String nombre, String dni, GregorianCalendar fechaInicial,
	...
	/**
	 * Funcion que calcula el coste que tendra el alquiler de un amarre a partir
	 * del numero de dias que se haya ocupado y el tipo de barco que lo ha
	 * ocupado.
	 * 
